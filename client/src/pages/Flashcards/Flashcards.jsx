...
const Flashcards = () => {
  ...
  return (
    <div>
      <PageHeader
        title="Flashcards"
        description="Pick a document to generate or study its AI flashcards."
      />
      ...
      {!isLoading && error && (
        <EmptyState icon={FiLayers} title="Couldn't load your documents" description={error} />
      )}
      ...
      {!isLoading && !error && documents.length === 0 && (
        <EmptyState
          ...
          description="Upload a PDF first, then come back here to generate flashcards."
          ...
          {documents.map((document) => (
            ...
            >
              ...
              <div className="mt-5 flex items-center justify-between">
                <span className="text-xs text-ink-faint dark:text-ink-dark-faint">Study flashcards</span>
